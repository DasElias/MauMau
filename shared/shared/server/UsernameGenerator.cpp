...
namespace card {
	std::string generateUsername() {
		bool isMale;
		return generateUsername(isMale);
	}
	std::string generateUsername(bool& out_isMale) {
		...
		static std::vector<std::string> const genders = {
			"w", "w", "w", "m", "w", "m", "m", "m", "w", "m", "m", "w", "m", "m", "w", "m", "w", "w", "m", "m", "w", "m", "m", "w", "m", "m", "m", "m", "m", "m", "m", "m", "w", "w", "m", "w", "w", "w", "m", "m", "w", "w", "w", "w", "m", "w", "m", "w", "w", "w", "m", "m", "m", "w", "w", "w", "w", "m", "m", "m", "w", "m", "m", "m", "m", "m", "m", "w", "w", "w", "m", "m", "m", "w", "w", "w", "w", "m", "m", "w", "w", "w", "m", "m", "m", "w", "w", "w", "w", "m", "m", "m", "m", "m", "w", "w", "m", "m", "m", "m", "m", "w", "m", "m", "m", "w", "w", "w", "w", "w", "w", "m", "m", "m", "m", "m", "w", "w", "w", "w", "w", "w", "m", "m", "m", "m", "m", "w", "w", "w", "w", "w", "w", "w", "m", "m", "m", "m", "m", "w", "w", "w", "w", "w", "w", "w", "w", "w", "w", "w", "w", "m", "m", "m", "m", "m", "m", "m", "m", "m", "m", "w", "w", "w", "w", "w", "w", "w", "w", "w", "m", "m", "m", "m", "m", "m", "m", "m", "m", "w", "w", "w", "w", "w", "w", "w", "w", "w", "w", "w", "w", "w", "w", "m", "w", "m", "w", "w", "w", "w", "m", "m", "w", "m", "m", "m", "m", "m", "m", "m", "m", "m", "m", "m", "w", "w", "w", "w", "w", "w", "w", "m", "w", "w", "m", "w", "w", "m", "w", "w", "w", "w", "w", "w", "m", "m", "w", "w", "m", "w", "w", "w", "w", "w", "w", "m", "w", "w", "w", "w", "w", "w", "m", "w", "w", "m", "m", "w", "m", "w", "w", "w", "m", "m", "w", "w", "m", "w", "w", "w"};

		std::size_t index = randomInRange<std::size_t>(0, usernames.size() - 1);
		out_isMale = (genders[index] == "m");
		return usernames[index];
	}
	std::string generateUsernameNotIn(const std::vector<std::string>& otherUsernames) {
		bool isMale;
		return generateUsernameNotIn(otherUsernames, isMale);
	}
	std::string generateUsernameNotIn(const std::vector<std::string>& otherUsernames, bool& out_isMale) {
		std::string generated;
		do {
			generated = generateUsername(out_isMale);
